...
% <tr>....a. <a href="matlab:cd([AAC_HomeDir '/Param_Est/Elec']);open_system('Motor_Param_Est');">Electric Motor</a><br>
% <tr>....b. <a href="matlab:cd([AAC_HomeDir '/Param_Est/Hydr']);open_system('Hydraulic_System_Param_Est');">Hydraulic System</a><br>
% <tr>8.  <a href="matlab:cd([AAC_HomeDir '/Custom_Resistor']);open_system('Custom_Analog_Filter');">Customize Component</a><br>
% <br>
...
% <tr>....a. <a href="matlab:cd([AAC_HomeDir '/Local_Solver']);edit sm_aileron_actuator_SLRT_elec">Electric Actuator</a><br>
% <tr>....b. <a href="matlab:cd([AAC_HomeDir '/Local_Solver']);edit sm_aileron_actuator_SLRT_hydr">Hydraulic Actuator</a><br>
% <tr>14. <a href="matlab:cd([AAC_HomeDir '/IP_Protect']);edit sm_aileron_actuator_IP_Protect">Protect IP To Share Model</a>, <a href="matlab:cd([AAC_HomeDir '/IP_Protect/Finish']);sm_aileron_actuator_open_system('sm_aileron_actuator_protected');">Open Protected Model</a><br>
% </style>
% </style>
% </html>
% 
