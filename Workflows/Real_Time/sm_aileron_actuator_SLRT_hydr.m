...
hydrPress_id = getparamid(tg, '','hydr_supply_pressure');
disp(['Pressure Source (current) = ' num2str(getparam(tg,hydrPress_id))]);
setparam(tg,hydrPress_id,hydr_supply_pressure.Value*0.7);
disp(['Pressure Source (new)     = ' num2str(getparam(tg,hydrPress_id))]);
